...
src_files = src/AbsLatte.hs src/LexLatte.hs src/ParLatte.hs src/Frontend.hs src/MainLatte.hs src/PrintLatte.hs src/Backend.hs src/Midend.hs src/Optimizations.hs
